class GeoLocalizacion {
    ...
    verMapa() {
        var mapa = new google.maps.Map(document.getElementById('mapa'), { zoom: 12, center: { lat: this.latitud, lng: this.longitud } });

        var marker = new google.maps.Marker({ position: { lat: this.latitud, lng: this.longitud }, map: mapa });
    }
}
